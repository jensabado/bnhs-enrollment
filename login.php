...
<head>
    ...
    <title>Login - Bacoor National High School</title>
                ...
                <div class="col-12 col-md-8 col-lg-4">
                    <div class="card shadow bg-white">
                        <div class="card-body p-5">
                            <div style="text-align: center;"><a href="index.php"><img src="assets/img/logo.png" alt=""
                                        width="150"></a></div>
                            ...
                            <div>
                                <p class="mb-0  text-center">Don't have an account? <a href="registration.php"
